"""
Django settings for ts_test_backend project.
...
SECRET_KEY = 'django-insecure-(9m@6$!zi7p#d2^j71tg*ql9lfsgeci0op*8wq!9ked4ku(5#5'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',  # Add your Next.js URL
]
...
REST_AUTH_TOKEN_MODEL = None  # Disable the token model

# Redirect URLs (can adjust as needed)
...
ACCOUNT_AUTHENTICATION_METHOD = 'email'  # Use 'username_email' if both options are allowed
...
WSGI_APPLICATION = 'ts_test_backend.wsgi.application'
